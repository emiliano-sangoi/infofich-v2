...
--
-- 1073 - II - 032006 1 -> carrera_id 11
-- 1069 - IA - 012006, 1 -> carrera_id 3
-- 1071 - IRH - 022006, 1 -> carrera_id 9
...
(NULL,11, 'FICHIRH03', 'COMUNICACIÓN TÉCNICA I - COMUNICACIÓN ELECTRÓNICA (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', 1,1, false, NOW()),
...
(NULL, 9, 'FICHIRH03', 'COMUNICACIÓN TÉCNICA I - COMUNICACIÓN ELECTRÓNICA (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '1er Cuatrimestre', 'cuatrimestre', 1,1, false, NOW()),
...
(NULL, 11,'FICHIRH03', 'COMUNICACIÓN TÉCNICA I - COMUNICACIÓN ORAL Y ESCRITA (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', 2,1, false, NOW()),
...
(NULL, 9, 'FICHIRH03', 'COMUNICACIÓN TÉCNICA I - COMUNICACIÓN ORAL Y ESCRITA (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '1er Cuatrimestre', 'cuatrimestre', 2, 1, false, NOW()),
...
(NULL, 11,'FICHIRH06', 'COMUNICACIÓN TÉCNICA II - SISTEMAS DE REPRESENTACIÓN (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '1er Cuatrimestre', 'cuatrimestre', 1,1, false, NOW()),
...
(NULL, 9, 'FICHIRH06', 'COMUNICACIÓN TÉCNICA II - SISTEMAS DE REPRESENTACIÓN (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', 1,1, false, NOW()),
...
(NULL, 11,'FICHIRH06', 'COMUNICACIÓN TÉCNICA II - CAD (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '1er Cuatrimestre', 'cuatrimestre', 2,1, false, NOW()),
...
(NULL, 9, 'FICHIRH06', 'COMUNICACIÓN TÉCNICA II - CAD (RECURSANTES)', 'N', NULL, '30.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', 2, 1, false, NOW()),
...
(NULL, 11,'FICHIRH01', 'MATEMÁTICA BÁSICA (RECURSANTES)', 'N', NULL, '90.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', NULL,1, false, NOW()),
(NULL, 11,'FICHIF003', 'QUÍMICA GENERAL (RECURSANTES)', 'N', NULL, '60.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', NULL,1, false, NOW()),
(NULL, 11,'FHUCMAT11', 'FUNDAMENTOS DE PROGRAMACIÓN (RECURSANTES)', 'N', NULL, '90.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', NULL,1, false, NOW()),

-- Para Ingeniería en Recursos Hídricos: Matemática Básica (Recursantes)  y Química General e Inorgánica (Recursantes)
(NULL, 9, 'FICHIRH01', 'MATEMÁTICA BÁSICA (RECURSANTES)', 'N', NULL, '90.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', NULL,1, false, NOW()),
(NULL, 9, 'FHUCBIO03', 'QUÍMICA GENERAL E INORGÁNICA (RECURSANTES)', 'N', NULL, '105.00', NULL, 1, 1, 1, '2do Cuatrimestre', 'cuatrimestre', NULL,1, false, NOW());
