...
--
-- Updates data for table `planif_planificaciones`
--

UPDATE `planif_planificaciones` SET `plan` = '082005' WHERE `planif_planificaciones`.`id` = 60;
UPDATE `planif_planificaciones` SET `plan` = '022006' WHERE `planif_planificaciones`.`id` = 61; 
UPDATE `planif_planificaciones` SET `plan` = '082005' WHERE `planif_planificaciones`.`id` = 62;
UPDATE `planif_planificaciones` SET `plan` = '012006' WHERE `planif_planificaciones`.`id` = 63;
UPDATE `planif_planificaciones` SET `plan` = '022006' WHERE `planif_planificaciones`.`id` = 65;
...
UPDATE `planif_planificaciones` SET `plan` = '012006' WHERE `planif_planificaciones`.`id` = 92;
UPDATE `planif_planificaciones` SET `plan` = '012006' WHERE `planif_planificaciones`.`id` = 94;
UPDATE `planif_planificaciones` SET `plan` = '022006' WHERE `planif_planificaciones`.`id` = 95;

UPDATE `planif_planificaciones` SET `plan` = '082005' WHERE `planif_planificaciones`.`id` = 96;
...
UPDATE `planif_planificaciones` SET `plan` = '082005' WHERE `planif_planificaciones`.`id` = 113;
